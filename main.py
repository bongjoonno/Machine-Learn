...
def main():
    ...
    np.save(save_path / 'GANON_regression_sbx', test_nonlinear_ga_param_optimizer())
    np.save(save_path / 'GANON_regression_arithmetic_crossover', test_nonlinear_ga_param_optimizer())
