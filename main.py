...
def main():
    ...
    np.save(save_path / 'GANON_regression_sbx_function_crossover_sympy', test_nonlinear_ga_param_optimizer(selection_method='threshold', crossover_method='sbx_function'))
