...
from .california_housing_data import california_housing_x, california_housing_y, california_housing_cols_to_scale

regression_test_data = [(california_housing_x, california_housing_y, california_housing_cols_to_scale)]
