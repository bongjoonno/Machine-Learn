...
def train_test_validate_split(x: DF | Series, y: Series, train_size: float = 0.80, test_size: float = 0.10, validation_size: float = 0.10) -> tuple[DF | Series, Series, DF | Series, Series, DF | Series, Series]:
